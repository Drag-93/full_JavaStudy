...
public class StringBufferEx2 {
	...
	public static void main(String[] args) {
		...
		StringBuffer sb4 = new StringBuffer("Spring boot JPA Securuty");
		...
		//역순 정렬
		System.out.println(sb3.reverse()); //역순 정렬
		System.out.println(sb3);
		...
		//원 문자열의 변화
		System.out.println(sb1);
		System.out.println(sb1.toString().concat("추가"));//원 문자열이 변경
		System.out.println(sb1);
		System.out.println();
		///////////////////////////////////////////
		...
		for(int i=0; i<5; i++) {
			responseBody.append("\t{'movieTitle':movie"+i+"} \n");
		}
		responseBody.append("]");
